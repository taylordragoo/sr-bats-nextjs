...
import SrBatsNavigation from "./elements/SrBatsNavigation";
...
const SrBatHeader = ({ aboutOverlay}) => {
                ...
                <Container className="wide">
                    <div className="header-content d-flex align-items-center justify-content-between position-relative space-py-mobile-only--30">
                        ...
                        <div className="header-content__logo d-flex align-items-center space-pr--15">
                            <Anchor path="/">
                                <img src="https://cdn.shopify.com/s/files/1/0413/2542/8896/files/sr_bats_updated_logo_1_180x.png?v=1683140696" alt="A description of the image" height={48} />
                            </Anchor>
                        </div>
